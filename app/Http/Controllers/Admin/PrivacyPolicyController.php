...
class PrivacyPolicyController extends Controller
{
    ...
    {
        $data = [
            'items' => PrivacyPolicy::latest('id')->get(),
        ];

        return view('admin.pages.privacy-policy.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        // Create and save the new Privacy & Policy record
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.pages.privacy-policy.edit', $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        // Find the existing Privacy & Policy and update it
        $item = PrivacyPolicy::findOrFail($id);
        $item->update([
            'title'           => $request->title,
            'content'         => $request->content,
