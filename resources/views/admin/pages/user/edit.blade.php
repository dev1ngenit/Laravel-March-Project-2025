        ...
        <div class="card-body pt-0">
            <form method="POST" action="{{ route('admin.user.update', $user->id) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <!-- Password -->
                    <div class="col-lg-3 mb-3">
                        <x-metronic.label for="password" class="col-form-label fw-bold fs-6">{{ __('Password') }}</x-metronic.label>
                    ...
                    <!-- Confirm Password -->
                    <div class="col-lg-3 mb-3">
                        <x-metronic.label for="password_confirmation" class="col-form-label fw-bold fs-6">{{ __('Confirm Password') }}</x-metronic.label>
                    ...
                    <!-- Image -->
                    <div class="col-lg-3 mb-3">
                        <x-metronic.label for="image" class="col-form-label fw-bold fs-6">{{ __('Image') }}</x-metronic.label>
                ...
                <div class="text-end pt-15">
                    <x-metronic.button type="submit" class="dark rounded-1 px-5">{{ __('Update') }}</x-metronic.button>
                </div>
            </form>
        </div>
    </div>
