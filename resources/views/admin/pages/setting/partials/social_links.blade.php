...
<div class="row mt-10">
    <div class="fv-row col-lg-4 mb-7">
        ...
        <x-metronic.input type="url" name="website_url" :value="old('website_url', optional($setting)->website_url)"
    ...
    <div class="fv-row col-lg-4 mb-7">
        <x-metronic.label class="fw-semibold fs-6 mb-2 required"><i class="fs-3 fa-brands fa-facebook pe-2"></i>Facebook
            URL</x-metronic.label>
        <x-metronic.input type="url" name="facebook_url" :value="old('facebook_url', optional($setting)->facebook_url)"
    ...
    <div class="fv-row col-lg-4 mb-7">
        ...
        <x-metronic.label class="fw-semibold fs-6 mb-2"><i class="fs-3 fa-brands fa-twitter pe-2"></i>Twitter
            URL</x-metronic.label>
        <x-metronic.input type="url" name="twitter_url" :value="old('twitter_url', optional($setting)->twitter_url)"
    ...
    <div class="fv-row col-lg-4 mb-7">
        ...
        <x-metronic.label class="fw-semibold fs-6 mb-2"><i class="fs-3 fa-brands fa-instagram pe-2"></i>Instagram
            URL</x-metronic.label>
        <x-metronic.input type="url" name="instagram_url" :value="old('instagram_url', optional($setting)->instagram_url)"
    ...
    <div class="fv-row col-lg-4 mb-7">
        ...
        <x-metronic.label class="fw-semibold fs-6 mb-2"><i class="fs-3 fa-brands fa-youtube pe-2"></i>Youtube
            URL</x-metronic.label>
        <x-metronic.input type="url" name="youtube_url" :value="old('youtube_url', optional($setting)->youtube_url)"
    ...
    <div class="fv-row col-lg-4 mb-7">
        ...
        <x-metronic.input type="url" name="linkedin_url" :value="old('linkedin_url', optional($setting)->linkedin_url)"
    ...
    <div class="fv-row col-lg-4 mb-7">
        ...
        <x-metronic.input type="url" name="whatsapp_url" :value="old('whatsapp_url', optional($setting)->whatsapp_url)"
    ...
    <div class="fv-row col-lg-4 mb-7">
        ...
        <x-metronic.input type="url" name="pinterest_url" :value="old('pinterest_url', optional($setting)->pinterest_url)"
    ...
    <div class="fv-row col-lg-4 mb-7">
        ...
        <x-metronic.input type="url" name="youtube_url" :value="old('tiktok_url', optional($setting)->tiktok_url)"
            class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Youtube URL" />
    </div>
</div>
