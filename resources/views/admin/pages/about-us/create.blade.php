<x-admin-app-layout :title="'Buying and Policy Create'">
    <div class="card card-flash">
        ...
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('admin.about-us.index') }}" class="btn btn-light-info">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="version" type="text" name="version" placeholder="Enter the version"
                            :value="old('version')"></x-metronic.input>
                    </div>

                    <div class="col-lg-3 mb-3">
                        <x-metronic.label for="effective_date"
                            class="col-form-label fw-bold fs-6">{{ __('Effective Date') }}</x-metronic.label>
                        <x-metronic.input id="effective_date" type="date" name="effective_date"
                            :value="old('effective_date')"></x-metronic.input>
                    </div>

                    <div class="col-lg-3 mb-3">
                        <x-metronic.label for="expiration_date"
                            class="col-form-label fw-bold fs-6">{{ __('Expiration Date') }}</x-metronic.label>
                        <x-metronic.input id="expiration_date" type="date" name="expiration_date"
                            :value="old('expiration_date')"></x-metronic.input>
                    </div>

                    <div class="col-lg-12 mb-3">
                        <x-metronic.label for="content" class="col-form-label fw-bold fs-6 ">{{ __('Content') }}
                        </x-metronic.label>
